module.exports = function(app){
    ...
    // app.get('/findemail',jwtMiddleware, group.findemail);//전체그룹조회
    // app.route('/user').post(jwtMiddleware, group.updateUserInfo);//그룹생성
    ...
    // app.route('/user').post(jwtMiddleware, group.updateUserInfo);//그룹 정보 수정
    // app.route('/user').post(jwtMiddleware, group.updateUserInfo);//그룹 삭제
